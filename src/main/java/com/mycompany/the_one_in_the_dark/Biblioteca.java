...
public class Biblioteca extends Ambiente {
    ...
    public static void main(String[] args) {
        ...
        for(int i= 0; i< Ambiente.getNumeroStanze().length; i++){
            System.out.println("Numero aula: " + Ambiente.getNumeroStanze()[i]);
        }

        // Stampa del nome delle stanze
        for (int j= 0; j< Ambiente.getNomiStanze().length; j++){
            System.out.println("Nome aula: " + Ambiente.getNomiStanze()[j]);
        }
        ...
        System.out.println("Il numero di aule presenti in " + Ambiente.getNomeAmbiente() + " è: " + Ambiente.getNumeroStanze().length);
    }
